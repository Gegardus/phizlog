class LikesController < ApplicationController
  ...
  # The type_subject?() method receives the parameters from the route 
  # and determines if the id obtained is that of a comment or a post
  ...
  # the dislike method essentially is the destroy method for the Likes controller
  def dislike(type)
